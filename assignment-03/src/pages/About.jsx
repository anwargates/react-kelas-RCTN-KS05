      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-4" data-aos="fade-right">
            <img src="/profile-img.png" className="img-fluid" alt="" />
          </div>
              ...
              <div className="col-lg-6">
                <ul>
                  <li>
                    ...
                    <strong>Birthday:</strong> <span>8 December 1995</span>
                  </li>
                  <li>
                    <i className="bi bi-chevron-right"></i>{" "}
              ...
              <div className="col-lg-6">
                <ul>
                  ...
                  <li>
                    ...
                    <span>Bachelor to be</span>
                  </li>
                  <li>
                    <i className="bi bi-chevron-right"></i>{" "}
                    <strong>Email:</strong> <span>manwarf8@gmail.com</span>
                  </li>
                  <li>
                    <i className="bi bi-chevron-right"></i>{" "}
