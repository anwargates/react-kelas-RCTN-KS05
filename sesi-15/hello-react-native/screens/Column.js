...
const styles = StyleSheet.create({
  ...
  style1Box1: { flex: 1, backgroundColor: "#FF731D" },
  style1Box2: { flex: 1, backgroundColor: "#FFF7E9" },
  style1Box3: { flex: 1, backgroundColor: "#5F9DF7" },

  style2Box: {
    flex: 1,
    flexDirection: "column",
  },
  style2Box1: { flex: 1, backgroundColor: "#FF731D" },
  style2Box2: { flex: 2, backgroundColor: "#FFF7E9" },
  style2Box3: { flex: 3, backgroundColor: "#5F9DF7" },

  style3Box: {
    flex: 1,
    flexDirection: "row",
  },
  style3Box1: { flex: 1, backgroundColor: "#FF731D" },
  style3Box2: { flex: 1, backgroundColor: "#FFF7E9" },
  style3Box3: { flex: 1, backgroundColor: "#5F9DF7" },
});
